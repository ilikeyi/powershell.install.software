...
$app = @(
	...
	("Mozilla Firefox",
	  ...
	  "Installation package\Browser",
	  "",
	  "http://ftp.mozilla.org/pub/firefox/releases/98.0/win32/ko/Firefox%20Setup%2098.0.exe",
	  "http://ftp.mozilla.org/pub/firefox/releases/98.0/win64/ko/Firefox%20Setup%2098.0.exe",
	  "",
	  "",
	  "Firefox*",
	  "/s",
