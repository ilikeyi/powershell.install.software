...
("Windows Defender Control",                              Paketname
 ...
 "/D",                                                    Betriebsparameter
 "",                                                      Vor dem Laufen
 "1:dfControl:ini")                                       Nach dem Ausführen: Wählen Sie Schema 1; dfControl = Name der Konfigurationsdatei; ini = Typ, gehen Sie zu Funktion OpenApp {}, um das Modul zu ändern
